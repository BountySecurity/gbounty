...
var _ scan.Modifier = MatchAndReplace{}

// MatchAndReplace is a [scan.Modifier] implementation that modifies the request
...
func (m MatchAndReplace) Modify(step *profile.Step, _ scan.Template, req request.Request) request.Request {
	cloned := req.Clone()
