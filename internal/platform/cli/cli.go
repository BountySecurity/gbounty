...
func Parse(args []string) (Config, error) {
	...
	fs.BoolVar(output, &config.Severity.High, "severity-filter", true, "If specified, only results with the given severity will be included in the output\n\tCan be used more than once: --severity-filter high --severity-filter medium")
