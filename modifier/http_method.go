...
var _ gbounty.Modifier = HTTPMethod{}

// HTTPMethod is a [gbounty.Modifier] implementation that changes the HTTP method of a [request.Request].
...
func (HTTPMethod) Modify(step *profile.Step, _ gbounty.Template, req request.Request) request.Request {
	cloned := req.Clone()
